...
- 完善`@CoolController`注解，新增`fieldLike`支持区分字段模糊查询，新增`serviceApis`直接将 service 方法注册为接口[详情](/src/guide/core/controller.html#服务注册成api)；
- Entity 字段支持配置字典和可选项[详情](/src/guide/core/db.html#配置字典和可选项-8-x新增)；
